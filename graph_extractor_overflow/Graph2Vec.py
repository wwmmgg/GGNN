...
from graph_extractor_overflow.vec2onehot import vec2onehot
...
if __name__ == "__main__":
    ...
    v_path = "../test/overflow/node/"
    e_path = "../test/overflow/edge/"

    fullnodes_ouptput_tmp = open("../test/overflow/fullnodes.json", 'w')

    contract_name = open("../test/overflow/name.txt")  # contracts list
    contract_label = open("../test/overflow/label.txt")  # contracts label
