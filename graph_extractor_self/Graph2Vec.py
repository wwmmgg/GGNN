...
from graph_extractor_self.vec2onehot import vec2onehot
...
if __name__ == "__main__":
    ...
    v_path = "../test/self/node/"
    e_path = "../test/self/edge/"

    fullnodes_ouptput_tmp = open("../test/self/fullnodes.json", 'w')

    contract_name = open("../test/self/name.txt")  # contracts list
    contract_label = open("../test/self/label.txt")  # contracts label
