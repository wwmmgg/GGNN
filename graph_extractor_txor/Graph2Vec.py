...
import json
import numpy as np
from graph_extractor_txor.vec2onehot import vec2onehot
...
if __name__ == "__main__":
    ...
    v_path = "../test/test_txor/node/"
    e_path = "../test/test_txor/edge/"

    fullnodes_ouptput_tmp = open("../test/test_txor/fullnodes.json", 'w')

    contract_name = open("../test/test_txor/name.txt")  # contracts list
    contract_label = open("../test/test_txor/label.txt")  # contracts label
