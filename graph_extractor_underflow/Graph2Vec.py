...
from graph_extractor_underflow.vec2onehot import vec2onehot
...
if __name__ == "__main__":
    ...
    v_path = "../test/underflow/node/"
    e_path = "../test/underflow/edge/"

    fullnodes_ouptput_tmp = open("../test/underflow/fullnodes.json", 'w')

    contract_name = open("../test/underflow/name.txt")  # contracts list
    contract_label = open("../test/underflow/label.txt")  # contracts label
