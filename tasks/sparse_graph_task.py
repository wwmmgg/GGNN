...
class Sparse_Graph_Task(ABC):
    ...
    def make_task_input_model(self,
        ...
        placeholders['ast_adjacency_lists'] = \
            [tf.placeholder(dtype=tf.int32, shape=[None, 2], name='ast_adjacency_e%s' % e)
        ...
        model_ops['ast_adjacency_lists'] = placeholders['ast_adjacency_lists']
